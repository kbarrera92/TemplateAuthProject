...
namespace TemplateProject.Migrations
{
    ...
    [Migration("20260917163539_AddPlatosYRecetas")]
    partial class AddPlatosYRecetas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TemplateProject.Dominio.Entidades.ItemReceta", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("PlatoId", "IngredienteId")
                        .IsUnique();

                    b.ToTable("ItemsReceta", (string)null);
                });

            modelBuilder.Entity("TemplateProject.Dominio.Entidades.Plato", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TemplateProject.Dominio.Entidades.ItemReceta", b =>
                {
                    b.HasOne("TemplateProject.Dominio.Entidades.Ingrediente", "Ingrediente")
                        .WithMany()
                        .HasForeignKey("IngredienteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TemplateProject.Dominio.Entidades.Plato", null)
